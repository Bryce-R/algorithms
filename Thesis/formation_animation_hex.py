"""
===========================
Formation animation of 6 quadcopters in hexagonal formation
===========================
tutorials from : 
...
Tri1Tplg1_data = sio.loadmat('data/Hex1Tplg1_data.mat')
Tri1Tplg2_data = sio.loadmat('data/Hex1Tplg2_data.mat')
...
ax1.set_xlim3d([-2.8, 8.5])
ax1.set_ylim3d([-2.0, 2.0])
ax1.set_zlim3d([-0.10, 0.3])
ax2.set_xlim3d([-2.8, 8.5])
ax2.set_ylim3d([-2.0, 2.0])
ax2.set_zlim3d([-0.15, 0.2])
ax3.set_xlim([-2.8, 8.5])
ax3.set_ylim([-0.15, 0.3])
ax4.set_xlim([-2.8, 8.5])
...
time_text1 = ax1.text(4, 1.0, 0.3, '')
time_text2 = ax2.text(4, 1.0, 0.2, '')
...
"""
# anim.save('formation_animation_hex.mp4', writer = 'mencoder', fps=15)
plt.show()
